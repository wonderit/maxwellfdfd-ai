...
DATA_PATH = "./data/4symData_381509.npz"
...
if __name__ == '__main__':
    ...
    if args.unit_test:
        ...
        print('use 4 sym (train set * 4)')
        all_data = np.load(DATA_PATH)
        print('keys : ', all_data.files)
        x_train_image = all_data['xtrain']
        x_train = all_data['wvtrain']
        y_train = all_data['ytrain']

        x_validation_image = all_data['xval']
        x_validation = all_data['wvval']
        y_validation = all_data['yval']

        x_test_image = all_data['xtest']
        x_test = all_data['wvtest']
        y_test = all_data['ytest']
