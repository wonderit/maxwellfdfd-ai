...
MODEL_ARRAY = [
    ...
    },
    {
        'color': 'b',
        'name': 'max_ce',
        'path': 'torch/al_g0_s0_nobn_ce_sgd_max_ce0.5_wd0.0_b32_e10_lr0.001_it5_K500/txt'
    },

    {
        'color': 'r',
        'name': 'ua_max_ce_sb1_ual0.1',
        'path': 'torch/al_g0_s0_rm_nobn_ualambda_residual_sb1.0_ual0.1_ce_sgd_max_ce0.5_wd0.0_b32_e10_lr0.001_it5_K500/txt'
    },
    {
        'color': 'orange',
        'name': 'ua_max_ce_sb1',
        'path': 'torch/al_g0_s0_rm_nobn_uaresidual_sb1.0_ce_sgd_max_ce0.5_wd0.0_b32_e10_lr0.001_it5_K500/txt'
    },
{
        'color': 'yellow',
        'name': 'ua_max_ce_sb100-e100',
        'path': 'torch/al_g0_s0_rm_nobn_uaresidual_sb10.0_ce_sgd_max_ce0.5_wd0.0_b32_e100_lr0.001_it5_K500/txt'
    },
{
        'color': 'brown',
...
{
        'color': 'lightblue',
        'name': 'ua_max_ce_sb300',
        'path': 'torch/al_g0_s0_rm_nobn_uaresidual_sb300.0_ce_sgd_max_ce0.5_wd0.0_b32_e100_lr0.001_it5_K500/txt'
    },
...

{
        'color': 'lightgreen',
        'name': 'ua_max_ce_tanh',
        'path': 'torch/al_g0_s0_rm_nobn_uaresidual_tanh_ce_sgd_max_ce0.5_wd0.0_b32_e100_lr0.001_it5_K500/txt'
    },


{
        'color': 'gray',
        'name': 'ua_max_ce_std_sigmoid',
        'path': 'torch/al_g0_s0_rm_nobn_uaresidual_std_sigmoid_ce_sgd_max_ce0.5_wd0.0_b32_e100_lr0.001_it5_K500/txt'
    },
]
...
plt.savefig('result-mnist-ua-e10-k500-all.png', dpi=300)
