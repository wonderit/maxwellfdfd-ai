...
MODEL_ARRAY = [
    {
        'color': 'k',
        'name': 'random',
        'path': 'torch/al_g0_s5_nobn_ce_adam_resnet_random0.5_wd0.0001_b128_e100_lr0.001_it10_K1000/txt'
    },
    {
        'color': 'b',
        'name': 'max_ce',
        'path': 'torch/al_g0_s2_nobn_ce_adam_resnet_max_ce0.5_wd0.0001_b128_e100_lr0.001_it10_K1000/txt'
    },

    {
        'color': 'r',
        'name': 'ua_max_ce',
        'path': 'torch/al_g0_s7_nobn_ualambda_residual_sb1.0_ual0.1_ce_adam_resnet_max_ce0.5_wd0.0001_b128_e100_lr0.001_it10_K1000/txt'
    },
    {
        'color': 'lightgray',
        'name': 'random_w',
...
plt.savefig('result-cifar10.png', dpi=300)
